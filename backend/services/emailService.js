...
const whatsappBlock = `
  <div style="text-align:center;margin:24px 0;">
    <a href="${WHATSAPP_LINK}" target="_blank"
      ...
      Join WhatsApp for Further Updates
    </a>
    <p style="margin:10px 0 0;color:#64748b;font-size:12px;">Get instant notifications, session reminders & announcements</p>
  </div>
`;
...
// headerGradient: CSS gradient string for the header background
// badgeHtml: optional inner badge HTML rendered below the subtitle
function buildHeader(headerGradient, subtextColor, badgeHtml = '') {
  return `
